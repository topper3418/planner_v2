...
def get_by_id(ticket_id: int) -> Optional[Ticket]:
    ...
    query = (
        "SELECT"
        " t.id, t.title, t.thing_id, t.category_id, t.description, t.parent_id, t.created_at, t.open, t.overdue, t.updated_at, t.completed_at, t.due_date, t.user_id, t.schedule_id,"
